...
def main():
    ...
    algos = [DecisionTreeClassifier(criterion='entropy', min_samples_leaf=50, max_depth=10),
    ...
    for i in range(1, 20):
        ...
        if i == 1:
            ...
            accuracy, _, _ = run_supervised_algo_single(cancer_data, ['Class'], DecisionTreeClassifier(criterion='entropy', min_samples_split=i, min_samples_leaf=int(i/2), max_depth=10))
